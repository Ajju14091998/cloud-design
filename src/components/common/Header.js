...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className="header">
        ...
        >
          <ul className="nav-links">
            {['Home', 'Services', 'About', 'Our Work', 'Careers', 'Blog'].map((item, index) => (
      ...
      >
        <motion.ul>
          <motion.li className="closebtn d-res" variants={mobileNavItemVariants}>
            <Link to="/">
          ...
          <motion.li className="bar d-res" variants={mobileNavItemVariants}></motion.li>
          <motion.li className="nav-social d-res" variants={mobileNavItemVariants}>
            <p>Follow</p>
            <div>
